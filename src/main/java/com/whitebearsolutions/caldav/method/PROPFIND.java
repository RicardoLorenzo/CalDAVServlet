...
public class PROPFIND extends CalDAVAbstractMethod
{
			...
			try
			{
				...
				if (req.getContentLength() > 0)
				{
					...
					try
					{
						...
						propNode = XMLHelper.findFirstSubElement(rootElement, "prop");
						if (propNode != null)
						{
							propertyFindType = FIND_BY_PROPERTY;
						}
						else if (XMLHelper.findFirstSubElement(rootElement, "propname") != null)
						{
							propertyFindType = FIND_PROPERTY_NAMES;
						}
						else if (XMLHelper.findFirstSubElement(rootElement, "allprop") != null)
						{
				...
				{
					propertyFindType = 0;
					properties = XMLHelper.getProperties(propNode);
				}
				...
				if (name.equals("calendar.ics"))
				{
					...
					try
					{
						...
						for (VTodo _vt : _vc.getVtodos())
						{
							...
							/*
							 * if(_vt.hasLastModified()) {
							 * XML.addProperty("D:getlastmodified",
							 * LAST_MODIFIED_DATE_FORMAT
							 * .format(_vt.getLastModified().getTime())); }
							 */
	...
	private String getETag(VTodo _vt)
	{
		// TODO Auto-generated method stub
		return null;
	}

	private String getETag(VEvent _ve)
	{
		// TODO Auto-generated method stub
		return null;
	}
				...
				for (String property : properties)
				{
					...
					else if (property.equals("resourcetype"))
					{
						if (isFolder)
						{
							...
							XML.addProperty("D:collection");
							/*
							 * TODO Identificar cuando es una coleccion de
							 * calendarios
							 */
