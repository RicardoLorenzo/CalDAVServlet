...
/**
 * CalDAVMethod interface
 * 
 * @author Ricardo Lorenzo
 */
public interface CalDAVMethod {
    void execute(CalDAVTransaction transaction, HttpServletRequest req, HttpServletResponse resp) throws  StorePathLockException, StorePathException, IOException;
}
