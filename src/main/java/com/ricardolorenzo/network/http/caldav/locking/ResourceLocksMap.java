...
public class ResourceLocksMap implements ResourceLocks {
     ...
     */
    protected Map<String, LockedObject> _locks = new ConcurrentHashMap<String, LockedObject>();

    /**
     * keys: id value: LockedObject from that id
     */
    protected Map<String, LockedObject> _id_locks = new ConcurrentHashMap<String, LockedObject>();

    /**
     * keys: path value: Temporary LockedObject from that path
     */
    protected Map<String, LockedObject> _temp_locks = new ConcurrentHashMap<String, LockedObject>();

    /**
     * keys: id value: Temporary LockedObject from that id
     */
    protected Map<String, LockedObject> _id_temp_locks = new ConcurrentHashMap<String, LockedObject>();
