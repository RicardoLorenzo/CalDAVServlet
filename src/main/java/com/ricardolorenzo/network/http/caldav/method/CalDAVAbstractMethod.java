...
public abstract class CalDAVAbstractMethod implements CalDAVMethod {
    ...
    public String getContentType(HttpServletRequest req)
   	...
   	public String getPrefer(HttpServletRequest req)
   	{
   		return req.getHeader("Prefer");
   	}
    ...
    protected String getETag(StoredObject so) {
        ...
        if (so != null && so.isResource()) {
            ...
            _sb.append("-");
            _sb.append(so.getLastModified().getTime() + 5);
        } else {
    ...
    protected String getETag(VAction va) {
        ...
        if (va != null && va.hasLastModified()) {
            ...
            _sb.append("-");
            _sb.append(va.getLastModified().getTimeInMillis() + 5);
        } else {
            _sb.append("0000-0000000000000000");
        }
        _sb.append("\"");
